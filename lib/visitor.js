...
class Visitor {
    ...
    #printCdsEntitiesType(file, fq, entity, singular, plural) {
        ...
        const addDraftsProperty = () => {
            file.cdsEntitiesType.add(`drafts: __.ArrayConstructable<__.DraftEntity<${singular}>>`)
        }
        ...
        if (isDraftEnabled) {
            file.cdsEntitiesType.addIndentedBlock(pluralEntityProp + ' & {', addDraftsProperty, '}')
        } else {
